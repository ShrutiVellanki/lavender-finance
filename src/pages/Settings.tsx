    ...
    <Layout>
      <div className="space-y-6 max-w-lg">
        <div className="flex items-center gap-3">
          <SettingsIcon className="w-8 h-8 text-lavenderDawn-iris dark:text-lavenderMoon-iris" />
          <h1 className="text-xl font-semibold tracking-[-0.02em] text-lavenderDawn-text dark:text-lavenderMoon-text">{t("settings.title")}</h1>
        </div>
